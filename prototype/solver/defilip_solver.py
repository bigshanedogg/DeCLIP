        ...
        for i in range(len(self.train_data['loader'])):
            ...
            if False:
                prec1, prec5 = accuracy(
                    logits_per_image_dense_1, filip_target, topk=(1, self.topk))
            else:
                prec1, prec5 = accuracy(
            ...
            if math.isnan(self.meters.losses.avg) or math.isnan(
                ...
                self.meters.filip_losses.reduce_update(reduced_filip_loss)
            ...
            if curr_step % self.config.saver.print_freq == 0 and self.dist.rank == 0:
                ...
                self.tb_logger.add_scalar(
                    'filip_loss_train', self.meters.filip_losses.avg, curr_step)
                self.tb_logger.add_scalar(
